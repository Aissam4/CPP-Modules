...
/*   Updated: 2022/04/05 21:43:35 by abarchil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string const name, const  int execute, const int signe)
{
    ...
    this->_Name = name;
    this->_ExecutedGrade = execute;
    this->_SignedGrade = signe;
    this->_Signe = false;
}
